    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex gap-2">
          <button onClick={() => setIsShareModalOpen(true)} className="px-4 py-2 border rounded-md text-sm font-semibold bg-white hover:bg-slate-50 text-slate-700 shadow-sm flex items-center"><Share className="w-4 h-4 mr-2 text-slate-400" /> Share</button>
